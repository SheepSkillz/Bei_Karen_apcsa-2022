...
public class FirstRunner
{
	public static void main( String args[] )
	{
		...
		System.out.println( s.go( new int[]{7, 7, 7, 7} ) );
		...
		System.out.println( s.go( new int[]{9,8,7,6,5,4,3,2,0,-2,9,9} ) );
		System.out.println( s.go( new int[]{12,15,18,21,23,1000} ) );
		System.out.println( s.go( new int[]{250,19,17,15,13,11,10,9,6,3,2,1,-455} ) );
		System.out.println( s.go( new int[]{} ) );
